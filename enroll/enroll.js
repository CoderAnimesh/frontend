document.addEventListener("DOMContentLoaded", () => {
  ...
  sendOtpBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      // step 1: check email
      const checkRes = await fetch("https://backend-960i.onrender.com/api/check-email", {
        method: "POST",
      ...
      const otpRes = await fetch(`https://backend-960i.onrender.com/api/otp/${eventId}/send`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  verifyOtpBtn.addEventListener("click", async () => {
    ...
    try {
      showLoader();
      const res = await fetch(`https://backend-960i.onrender.com/api/otp/${eventId}/verify`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  enrollBtn.addEventListener("click", async () => {
    ...
    try {
      showLoader();
      const res = await fetch("https://backend-960i.onrender.com/api/participants/enroll", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
